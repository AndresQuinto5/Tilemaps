...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "v2.4.1"
  WORKING_DIRECTORY "/home/imag1ne/GameEngines/tilemaps/Sprite-animation-systems/build/_deps/box2d-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/imag1ne/GameEngines/tilemaps/Sprite-animation-systems/build/_deps/box2d-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/imag1ne/GameEngines/tilemaps/Sprite-animation-systems/build/_deps/box2d-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
